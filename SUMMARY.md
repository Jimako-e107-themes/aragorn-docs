...
* [theme_shortcodes.php](skeleton/theme-shortcodes.md)
  * [{HEADER}](skeleton/shortcodes/header.md)
  * [{FOOTER}](skeleton/shortcodes/footer.md)
  * [{BODY_CLASS}](skeleton/shortcodes/body-class.md)
  * [{PAGE_CLASS}](skeleton/shortcodes/page-class.md)
  * [{THEME_TOGGLE}](skeleton/shortcodes/theme-toggle.md)
  * [{THEME_MENUAREA}](skeleton/shortcodes/theme-menuarea.md)
  * [{BOTTOM_NAV}](skeleton/shortcodes/bottom-nav.md)       
  * [{TILES}](skeleton/shortcodes/tiles.md)                 
  * [{ADVANCED_LOGIN_LINK}](skeleton/shortcodes/advanced-login-link.md)
  * [{ADVANCED_SIGNUP_LINK}](skeleton/shortcodes/advanced-signup-link.md)
  * [{ADVANCED_FPW_BUTTON}](skeleton/shortcodes/advanced-fpw-button.md)
