...
**Status: 90% — the contract is settled, two brands ship, a third would be the real test.**
...
Two brand files exist:

| File | Site | Identity |
| --- | --- | --- |
| `css/brand-e107sk.css` | e107.sk | blue `#0099da`, light header, dark navigation |
| `css/brand-hpkizi.css` | hpkizi.sk | royal purple `#5f4b8b`, coloured header |
...
Two worked examples from the shipped files:

- **e107.sk blue `#0099da`** reaches 3.2:1 on white. It is fine as a hero fill
  or a large display heading, and unusable behind body text. `--brand-blue-ui`
  (`#007cb2`, 4.6:1) exists for everything that carries text.
- **hpkizi dahlia `#e69a8d`** reaches 2.2:1 on white — it fails both as a text
  colour and as a surface under white text. It is a surface with *dark* text,
  and `--brand-dahlia-ui` (`#a85c4e`, 4.9:1) covers the rest.
