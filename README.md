...
* [ ] [News templates](../plugins/news.md) — `████████░░` **80%**
  All template files written (main, view, grid, menu); a running
  [checklist](../plugins/news-checklist.md) tracks live verification and
  two remaining fixes (caption, category link) plus one open bug
